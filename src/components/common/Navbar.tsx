        ...
        <header className={`${styles.header} ${isScrolled ? styles.scrolled : ''}`}>
            ...
            <div className={`${styles.offcanvasSidebar} ${isMenuOpen ? styles.offcanvasOpen : ''}`}>
                ...
                <div className={styles.offcanvasBody}>
                    <Link href="/" className={styles.offcanvasLink}>Home</Link>
                    <Link href="/about" className={styles.offcanvasLink}>About</Link>
                    ...
                    {/* <Link href="/portfolio" className={styles.offcanvasLink}>Portfolio</Link> */}
                    <Link href="/blog" className={styles.offcanvasLink}>Blog</Link>
                    <Link href="/contact" className={styles.offcanvasLink}>Contact</Link>
