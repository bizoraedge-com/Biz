        ...
        <header className={`${styles.header} ${isScrolled ? styles.scrolled : ''}`}>
                    ...
                    <div className={styles.navLinkWrapper}>
                        ...
                        <div className={styles.megaMenu}>
                            <div className={styles.megaMenuBody}>
                                <div className={styles.featuresArea}>
                                    ...
                                    <div className={styles.featuresGrid}>
                                        <Link href="/services/web-development" className={styles.featureItem} style={{ textDecoration: 'none' }}>
                                        ...
                                        <Link href="/services/mobile-app-development" className={styles.featureItem} style={{ textDecoration: 'none' }}>
                                            <div className={styles.featureIcon}>
                                        ...
                                        <Link href="/services/crm-development" className={styles.featureItem} style={{ textDecoration: 'none' }}>
                                            <div className={styles.featureIcon}>
                                        ...
                                        <Link href="/services/iot-solutions" className={styles.featureItem} style={{ textDecoration: 'none' }}>
                                            <div className={styles.featureIcon}>
                                        ...
                                        <Link href="/services/blockchain-development" className={styles.featureItem} style={{ textDecoration: 'none' }}>
                                            <div className={styles.featureIcon}>
                                        ...
                                        <Link href="/services/fintech-solutions" className={styles.featureItem} style={{ textDecoration: 'none' }}>
                                            <div className={styles.featureIcon}>
                                        ...
                                        <Link href="/services/enterprise-software" className={styles.featureItem} style={{ textDecoration: 'none' }}>
                                            <div className={styles.featureIcon}>
                                        ...
                                        <Link href="/services/digital-marketing" className={styles.featureItem} style={{ textDecoration: 'none' }}>
                                            <div className={styles.featureIcon}>
                                        ...
                                        <Link href="/services/custom-solutions" className={styles.featureItem} style={{ textDecoration: 'none' }}>
                                            <div className={styles.featureIcon}>
                            ...
                            <div className={styles.megaMenuFooter}>
                                ...
                                <button className={styles.footerBtn} onClick={() => setIsDemoModalOpen(true)}>Get Started</button>
                            </div>
                        </div>
                    </div>
            ...
            <div className={`${styles.offcanvasSidebar} ${isMenuOpen ? styles.offcanvasOpen : ''}`}>
                ...
                <div className={styles.offcanvasBody}>
                    <Link href="/" className={styles.offcanvasLink} onClick={() => setIsMenuOpen(false)}>Home</Link>
                    <Link href="/about" className={styles.offcanvasLink} onClick={() => setIsMenuOpen(false)}>About</Link>
                    ...
                    {isMobileServicesOpen && (
                        <div className={styles.mobileDropdown}>
                            <div className={styles.megaMenuBody} style={{ padding: '0', flexDirection: 'column' }}>
                                <div className={styles.featuresArea}>
                                    <div className={styles.featuresGrid}>
                                        <Link href="/services/web-development" className={styles.featureItem} style={{ textDecoration: 'none' }} onClick={() => setIsMenuOpen(false)}>
                                            <div className={styles.featureIcon}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
                                            </div>
                                            <div className={styles.featureText}>
                                        ...
                                        <Link href="/services/mobile-app-development" className={styles.featureItem} style={{ textDecoration: 'none' }} onClick={() => setIsMenuOpen(false)}>
                                            <div className={styles.featureIcon}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>
                                            </div>
                                            <div className={styles.featureText}>
                                        ...
                                        <Link href="/services/crm-development" className={styles.featureItem} style={{ textDecoration: 'none' }} onClick={() => setIsMenuOpen(false)}>
                                            <div className={styles.featureIcon}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                                            </div>
                                            <div className={styles.featureText}>
                                        ...
                                        <Link href="/services/iot-solutions" className={styles.featureItem} style={{ textDecoration: 'none' }} onClick={() => setIsMenuOpen(false)}>
                                            <div className={styles.featureIcon}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                                            </div>
                                            <div className={styles.featureText}>
                                        ...
                                        <Link href="/services/blockchain-development" className={styles.featureItem} style={{ textDecoration: 'none' }} onClick={() => setIsMenuOpen(false)}>
                                            <div className={styles.featureIcon}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>
                                            </div>
                                            <div className={styles.featureText}>
                                        ...
                                        <Link href="/services/fintech-solutions" className={styles.featureItem} style={{ textDecoration: 'none' }} onClick={() => setIsMenuOpen(false)}>
                                            <div className={styles.featureIcon}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>
                                            </div>
                                            <div className={styles.featureText}>
                                        ...
                                        <Link href="/services/enterprise-software" className={styles.featureItem} style={{ textDecoration: 'none' }} onClick={() => setIsMenuOpen(false)}>
                                            <div className={styles.featureIcon}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="4" y="4" width="16" height="16" rx="2" ry="2"/><rect x="9" y="9" width="6" height="6"/></svg>
                                            </div>
                                            <div className={styles.featureText}>
                                        ...
                                        <Link href="/services/digital-marketing" className={styles.featureItem} style={{ textDecoration: 'none' }} onClick={() => setIsMenuOpen(false)}>
                                            <div className={styles.featureIcon}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></svg>
                                            </div>
                                            <div className={styles.featureText}>
                                        ...
                                        <Link href="/services/custom-solutions" className={styles.featureItem} style={{ textDecoration: 'none' }} onClick={() => setIsMenuOpen(false)}>
                                            <div className={styles.featureIcon}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 22 8.5 22 15.5 12 22 2 15.5 2 8.5 12 2"/></svg>
                                            </div>
                                            <div className={styles.featureText}>
                    ...
                    {/* <Link href="/portfolio" className={styles.offcanvasLink} onClick={() => setIsMenuOpen(false)}>Portfolio</Link> */}
                    <Link href="/blog" className={styles.offcanvasLink} onClick={() => setIsMenuOpen(false)}>Blog</Link>
                    <Link href="/contact" className={styles.offcanvasLink} onClick={() => setIsMenuOpen(false)}>Contact</Link>
